    ...
    return `<section class="about" id="about">
                ...
                <div class="about__wrapper">
                    <div class="about__item">
                        ...
                        <p class="about__item__title">Video Creator / <span>Motion Graphics Designer</span></p>
                        <p class="about__item__skill"> <span>SKILL</span> MotionGraphics // MusicVideo // Graphics Design</p>
            ...
            <section class="contact">
                ...
                <h2 class="desc">If you are interested, please contact me via email or discord below</h2>
                <div class="contact__wrapper">
                    <span class="contact__social">Email</span>
                    <a href="mailto:kimeyukawa@gmail.com" class="contact__mail">kimeyukawa@gmail.com</a>
                </div>

                <div class="contact__wrapper">
                    <span class="contact__social">Discord</span>
                    <div class="contact__wrapper__discord">
                        <a href="https://discordapp.com/users/683574461147906078" class="contact__discord">kimeyu_39</a>
                        ...
                        <div id="msg__copy" class="msg__copy">Copied successfully!</div>
                    </div>
                </div>
            </section>`;
}
